...
local DevTools = Language["|Hcommand:/reload|h|cFF%s[Reload UI]|r|h |Hcommand:/eventtrace|h|cFF%s[Event Trace]|r|h |Hplayer:%s|h|cFF%s[Whisper Self]|r|h |Hcommand:/framestack|h|cFF%s[Frame Stack]|r|h |Hcommand:/hui move|h|cFF%s[Move]|r|h"]
...
function HydraUI:WelcomeMessage()
	if Settings["ui-display-welcome"] then
		...
		if Settings["ui-display-dev-tools"] then
			...
			print(format(DevTools, Color1, Color1, Name, Color1, Color1, Color1))
