...
Assets:SetFont("Visitor", "Interface\\Addons\\HydraUI\\Assets\\Fonts\\Visitor.ttf", nil, true)
Assets:SetFont("Pixel Arial", "Interface\\Addons\\HydraUI\\Assets\\Fonts\\PixelArial.ttf", nil, true)
