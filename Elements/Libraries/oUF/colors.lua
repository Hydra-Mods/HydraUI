...
function HydraUI:UpdateoUFColors()
	...
	colors.power.STAGGER[1] = {HydraUI:HexToRGB(Settings["color-stagger-1"])}
	colors.power.STAGGER[2] = {HydraUI:HexToRGB(Settings["color-stagger-2"])}
	colors.power.STAGGER[3] = {HydraUI:HexToRGB(Settings["color-stagger-3"])}
