...
if( playerClass == "DRUID" ) then
	LoadClassData = function()
		...
		if isWrath then
			...
			hotData[Lifebloom] = {interval = 1, ticks = 7, coeff = 0.66626, dhCoeff = 0.517928287, levels = {1, 64, 72, 80}, averages = {224, 287, 371}, bomb = {480, 616, 776}}
			...
			hotData[Lifebloom] = {interval = 1, ticks = 7, coeff = 0.52, dhCoeff = 0.34335, levels = {1}, averages = {273}, bomb = {600}}
		end
		if isWrath then
