...
Language["Display a welcome message on login with UI information"] = "在登录时显示带有界面信息的欢迎"
Language["Display Developer Chat Tools"] = "显示开发者聊天工具"
...
Language["While toggled, you can drag some elements of vUI around the screen"] = "开启后,你可以在屏幕上拖动vUI的某些界面元素"
...
Language["Restore all vUI movable frames to their default locations"] = "将所有 vUI 界面元素还原到其默认位置"
Language["Settings Window"] = "设置窗口"
Language["Hide In Combat"] = "在战场中隐藏"
Language["Hide the settings window when engaging in combat"] = "在战斗中隐藏设置窗口"
Language["Fade While Moving"] = "移动时淡入淡出"
Language["Fade out The settings window while moving"] = "在移动时淡出设置窗口"
Language["Set Faded Opacity"] = "设置不透明度"
Language["Set the opacity of the settings window while faded"] = "设置窗口在移动中的淡入淡出透明度"
Language["Welcome to |cFF%svUI|r version |cFF%s%s|r."] = "欢迎使用 |cFF%svUI|r version |cFF%s%s|r."
Language["Type |cFF%s/vui|r to access the settings window, or click |cFF%s|Hcommand:/vui|h[here]|h|r."] = "输入 |cFF%s/vui|r 打开设置窗口, 或者点击 |cFF%s|H 命令:/vui|h[here]|h|r."
...
Language["Show"] = "显示"
Language["Hide"] = "隐藏"
Language["Mouseover"] = "鼠标移入"
Language["Set Visibility"] = "设置可见性"
Language["Set the visibility of the bag frame"] = "设置背包的可见性"
Language["Set Faded Opacity"] = "设置不透明度"
Language["Set the opacity of the bags frame whenvisiblity is set to Mouseover"] = "当可见性为鼠标移入时的背包的不透明度"
...
Language["Misc Colors"] = "其他 Colors"
Language["Tagged"] = "标签"
...
Language["Progress Text"] = "进度数值文本"
Language["Set when to display the progress information"] = "设置显示进度数值文本"
Language["Percent Text"] = "进度百分比文本"
Language["Set when to display the percent information"] = "设置显示进度百分比文本"
...
Language["Set the opacity of the micro menu buttons when visiblity is set to Mouseover"] = "当显示设置为鼠标移入时，设置迷你菜单按钮的不透明度"
...
Language["Header Font Size"] = "头部字体大小"
Language["Set the font size of header elements in the UI"] = "设置UI头部字体大小"
