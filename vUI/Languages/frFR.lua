...
Language["While toggled, you can drag some elements of vUI around the screen"] = "While toggled, you can drag some elements of vUI around the screen"
...
Language["Restore all vUI movable frames to their default locations"] = "Restore all vUI movable frames to their default locations"
...
Language["Welcome to |cFF%svUI|r version |cFF%s%s|r."] = "Bienvenue sur |cFF%svUI|r version |cFF%s%s|r."
Language["Type |cFF%s/vui|r to access the settings window, or click |cFF%s|Hcommand:/vui|h[here]|h|r."] = "Tapez |cFF%s/vui|r pour accéder à la fenêtre des paramètres, ou cliquez |cFF%s|Hcommand:/vui|h[içi]|h|r."
...
Language["Enable the vUI chat module"] = "Enable the vUI chat module"
...
Language["Enable the vUI chat bubbles module"] = "Enable the vUI chat bubbles module"
Language["Background Opacity"] = "Background Opacity"
