...
GUI:AddOptions(function(self)
	...
	Right:CreateDoubleLine("|cFFA335EEMrPoundsign|r", "|cFF0070DDMisse Far|r")
	...
	Right:CreateDoubleLine("|cFF1EFF00Mitooshin|r", "|cFF1EFF00FrankPatten|r")
	Right:CreateDoubleLine("|cFF1EFF00Ryex|r", "madmaddy")
