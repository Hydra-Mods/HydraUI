...
local TH = vUI:NewModule("Talking Head")
...
function TH:ApplyStyle()
	vUI:SetFontInfo(TalkingHeadFrame.NameFrame.Name, Settings["ui-font"], 22, Settings["ui-font-flags"])
	vUI:SetFontInfo(TalkingHeadFrame.TextFrame.Text, Settings["ui-font"], 16, Settings["ui-font-flags"])
	...
	TalkingHeadFrame.BG:SetBackdrop(vUI.BackdropAndBorder)
	...
	TalkingHeadFrame.ModelBG:SetVertexColor(vUI:HexToRGB(Settings["ui-main-color"]))
	...
	TalkingHeadFrame.Outline:SetBackdrop(vUI.Outline)
...
function TH:Load()
	...
	self.Mover = CreateFrame("Frame", "vUI Talking Head", vUIParent)
	self.Mover:SetSize(570, 155)
	self.Mover:SetPoint("TOP", vUIParent, 0, -100)
	
	vUI:CreateMover(self.Mover)
end
