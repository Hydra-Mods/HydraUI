...
GUI:AddOptions(function(self)
	...
	Left:CreateSwitch("cooldowns-enable", Settings["cooldowns-enable"], Language["Enable Cooldown Flash"], Language["When an ability comes off cooldown|n the icon will flash as an alert"], UpdateEnableCooldownFlash)
end)