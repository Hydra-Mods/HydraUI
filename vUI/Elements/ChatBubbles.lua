...
function Bubbles:RefreshBubble(bubble)
	...
	vUI:SetFontInfo(bubble:GetChildren().Text, Settings["chat-bubbles-font"], Settings["chat-bubbles-font-size"], Settings["chat-bubbles-font-flags"])
...
function Bubbles:SkinBubble(bubble)
	...
	vUI:SetFontInfo(Child.String, Settings["chat-bubbles-font"], Settings["chat-bubbles-font-size"], Settings["chat-bubbles-font-flags"])
	...
	bubble.Backdrop:SetBackdrop(vUI.BackdropAndBorder)
