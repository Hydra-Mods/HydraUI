...
GUI:AddOptions(function(self)
	...
	Left:CreateSlider("unitframes-player-health-height", Settings["unitframes-player-health-height"], 6, 60, 1, Language["Health Bar Height"], Language["Set the height of the player health bar"], UpdatePlayerHealthHeight)
	Left:CreateSlider("unitframes-player-power-height", Settings["unitframes-player-power-height"], 2, 30, 1, Language["Power Bar Height"], Language["Set the height of the player power bar"], UpdatePlayerPowerHeight)
	Left:CreateSlider("unitframes-player-cast-width", Settings["unitframes-player-cast-width"], 80, 360, 1, Language["Cast Bar Width"], Language["Set the width of the player cast bar"], UpdatePlayerCastBarSize)
	...
	Left:CreateInput("unitframes-player-power-left", Settings["unitframes-player-power-left"], Language["Left Power Text"], Language["Set the text on the left of the player power bar"], ReloadUI):RequiresReload(true)
	Left:CreateInput("unitframes-player-power-right", Settings["unitframes-player-power-right"], Language["Right Power Text"], Language["Set the text on the right of the player power bar"], ReloadUI):RequiresReload(true)
	
	Right:CreateHeader(Language["Target"])
	Right:CreateSlider("unitframes-target-width", Settings["unitframes-target-width"], 120, 320, 1,  Language["Width"], Language["Set the width of the target unit frame"], UpdateTargetWidth)
	Right:CreateSlider("unitframes-target-health-height", Settings["unitframes-target-health-height"], 6, 60, 1,  Language["Health Bar Height"], Language["Set the height of the target health bar"], UpdateTargetHealthHeight)
	...
	Right:CreateInput("unitframes-target-health-right", Settings["unitframes-target-health-right"], Language["Right Health Text"], Language["Set the text on the right of the target health bar"], ReloadUI):RequiresReload(true)
	...
	Left:CreateSlider("unitframes-targettarget-power-height", Settings["unitframes-targettarget-power-height"], 1, 30, 1, Language["Power Bar Height", Language["Set the height of the target of target power bar"], UpdateTargetTargetPowerHeight)
	...
	Right:CreateSlider("unitframes-pet-width", Settings["unitframes-pet-width"], 60, 320, 1, Language["Width"], Language["Set the width of the pet unit frame"], UpdatePetWidth)
	Right:CreateSlider("unitframes-pet-health-height", Settings["unitframes-pet-health-height"], 6, 60, 1, Language["Health Bar Height"], Language["Set the height of the pet health bar"], UpdatePetHealthHeight)
	...
	Right:CreateSlider("unitframes-focus-width", Settings["unitframes-focus-width"], 60, 320, 1, Language["Width"], Language["Set the width of the focus unit frame"], UpdateFocusWidth)
	Right:CreateSlider("unitframes-focus-health-height", Settings["unitframes-focus-health-height"], 6, 60, 1, Language["Health Bar Height"], Language["Set the height of the focus health bar"], UpdateFocusHealthHeight)
	...
	Right:CreateDropdown("unitframes-focus-health-color", Settings["unitframes-focus-health-color"], {[Language["Class"]] = "CLASS", [Language["Reaction"]] = "REACTION", [Language["Custom"]] = "CUSTOM"}, Language["Health Bar Color"], Language["Set the color of the health bar"], UpdateFocusHealthColor)
	...
	Right:CreateSwitch("unitframes-focus-health-reverse", Settings["unitframes-focus-health-reverse"], Language["Reverse Health Fill"], Language["Reverse the fill of the health bar"], UpdateFocusHealthFill)
