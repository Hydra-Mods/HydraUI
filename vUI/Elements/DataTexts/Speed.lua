...
local OnEnter = function(self)
	...
	GameTooltip:AddLine(format(CR_SPEED_TOOLTIP, vUI:Comma(GetCombatRating(CR_SPEED)), GetCombatRatingBonus(CR_SPEED)), nil, nil, nil, true)
...
vUI:AddDataText("Speed", OnEnable, OnDisable, Update)