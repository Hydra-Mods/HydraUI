...
function Window:CreateSingleWindow()
	...
	self.Bottom = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.BottomFrame = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.Left = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.Right = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.Top = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.Backdrop = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.TopBar = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.OuterOutline = CreateFrame("Frame", "vUIMetersFrame", self.Bottom, "BackdropTemplate")
...
function Window:CreateDoubleWindow()
	...
	self.TopLeft = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.TopLeft.Texture:SetVertexColor(vUI:HexToRGB(Settings["ui-window-main-color"]))
	
	self.TopRight = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
	...
	self.TopRight.Texture:SetVertexColor(vUI:HexToRGB(Settings["ui-window-main-color"]))
	
	self.BackdropMiddle = CreateFrame("Frame", nil, vUI.UIParent, "BackdropTemplate")
