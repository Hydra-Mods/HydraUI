...
function Chat:StyleChatFrame(frame)
	...
	EditBox.Backdrop:SetPoint("BOTTOMRIGHT", vUIChatFrameBottom, 0, 0)
...
GUI:AddOptions(function(self)
	...
	Right:CreateSlider("chat-font-size", Settings["chat-font-size"], 8, 32, 1, Language["Font Size"], "Set the font size of the chat frame", UpdateChatFont)
	...
	Right:CreateSlider("chat-tab-font-size", Settings["chat-tab-font-size"], 8, 32, 1, Language["Font Size"], "Set the font size of the chat frame tabs", UpdateChatTabFont)
