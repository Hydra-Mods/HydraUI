...
GUI:AddOptions(function(self)
	...
	Right:CreateSwitch("chat-bubbles-enable", Settings["chat-bubbles-enable"], Language["Enable Chat Bubbles Module"], Language["Enable the vUI chat bubbles module"], ReloadUI):RequiresReload(true)
