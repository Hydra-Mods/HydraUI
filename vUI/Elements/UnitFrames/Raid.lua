...
vUI.StyleFuncs["raid"] = function(self, unit)
	...
	vUI:SetFontInfo(HealthName, Settings["raid-font"], Settings["raid-font-size"], Settings["raid-font-flags"])
	...
	vUI:SetFontInfo(HealthBottom, Settings["raid-font"], Settings["raid-font-size"], Settings["raid-font-flags"])
	...
	if UF.BuffIDs[vUI.UserClass] then
		...
		for key, spell in pairs(UF.BuffIDs[vUI.UserClass]) do
			...
			vUI:SetFontInfo(Count, Settings["raid-font"], 10)
